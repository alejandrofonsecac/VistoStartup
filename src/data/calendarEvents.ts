import type { Aluno, CalendarEvent, CalendarEventType } from '../types'

export const CALENDAR_EVENTS: CalendarEvent[] = [
  {
    id: 'ce1', turmaId: 't1', title: 'Lista de exercícios — Equações', type: 'assignment',
  ...
  {
    id: 'ce2', turmaId: 't1', title: 'Prova de Matemática', type: 'exam',
  ...
  {
    id: 'ce3', turmaId: 't1', title: 'Pesquisa: Independência do Brasil', type: 'project',
  ...
  {
    id: 'ce4', turmaId: 't1', title: 'Reunião de pais e mestres', type: 'school-event',
  ...
  {
    id: 'ce5', turmaId: 't1', title: 'Mapa conceitual: Ecossistemas', type: 'project',
  ...
  {
    id: 'ce6', turmaId: 't1', title: 'Passeio ao Museu de Arte', type: 'school-event',
  ...
  {
    id: 'ce7', turmaId: 't2', title: 'Produção textual: Conto', type: 'assignment',
  ...
  {
    id: 'ce8', turmaId: 't2', title: 'Feira de Ciências', type: 'school-event',
  ...
  {
    id: 'ce9', turmaId: 't2', title: 'Trabalho: Minha cidade sustentável', type: 'project',
  ...
  {
    id: 'ce10', turmaId: 't2', title: 'Avaliação de leitura', type: 'exam',
  ...
  {
    id: 'ce11', turmaId: 't2', title: 'Entrega do diário de leitura', type: 'assignment',
  ...
  {
    id: 'ce12', turmaId: 't1', studentId: 'a3', title: 'Recuperação de Matemática', type: 'exam',
...
export function getCalendarEventsForStudent(events: CalendarEvent[], student: Aluno | undefined): CalendarEvent[] {
  if (!student) return []
  return events.filter(event => event.turmaId === student.turmaId && (!event.studentId || event.studentId === student.id))
}
